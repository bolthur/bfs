...
int fat_file_read( fat_file_t* file, void* buffer, size_t size, size_t* read_count );
int fat_file_write( fat_file_t* file, void* buffer, size_t size, size_t* write_count );
