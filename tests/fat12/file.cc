...
TEST( fat12, file_open_non_existant_file ) {
...
TEST( fat12, file_open2_non_existant_file ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
TEST( fat12, file_open_existant_file ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
TEST( fat12, file_open2_existant_file ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
TEST( fat12, file_open_create_file_rofs ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to create file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
TEST( fat12, file_open_create_file_rwfs ) {
...
TEST( fat12, file_open_truncate_file ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to create file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2(
    &file,
    "/fat12/hello/file/open/truncate.txt",
    O_RDWR
  );
  EXPECT_EQ( result, EOK );
  EXPECT_NE( file.fsize, 0 );
...
TEST( fat12, file_open_create_file_short_short_ext ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to create file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/asd1.txt", O_RDWR | O_CREAT );
  EXPECT_EQ( result, EOK );
  // close file again
  result = fat_file_close( &file );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_open_create_file_short_long_ext ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to create file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/asd2.jpeg", O_RDWR | O_CREAT );
  EXPECT_EQ( result, EOK );
  // close file again
  result = fat_file_close( &file );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_open_create_file_long_short_ext ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to create file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/asdftolongname.txt", O_RDWR | O_CREAT );
  EXPECT_EQ( result, EOK );
  // close file again
  result = fat_file_close( &file );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_open_create_file_long_long_ext ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to create file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/asdftolongname2.jpeg", O_RDWR | O_CREAT );
  EXPECT_EQ( result, EOK );
  // close file again
  result = fat_file_close( &file );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_read_normal2 ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  // load root dir
  int result = fat_file_open( &file, "/fat12/hello/world.txt", "r" );
  EXPECT_EQ( result, EOK );
  EXPECT_NE( file.cluster, 0 );
  EXPECT_NE( file.fsize, 0 );
  EXPECT_TRUE( file.mp );
...
TEST( fat12, file_read_rootdir ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  // load root dir
  int result = fat_file_open( &file, "/fat12/world.txt", "r" );
  EXPECT_EQ( result, EOK );
  EXPECT_NE( file.cluster, 0 );
  EXPECT_NE( file.fsize, 0 );
  EXPECT_TRUE( file.mp );
...
TEST( fat12, file_read_write_only ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  // load root dir
  int result = fat_file_open2( &file, "/fat12/world.txt", O_WRONLY );
  EXPECT_EQ( result, EOK );
  EXPECT_NE( file.cluster, 0 );
  EXPECT_NE( file.fsize, 0 );
  EXPECT_TRUE( file.mp );
...
TEST( fat12, file_write_append ) {
  ...
  int result = fat_file_open2(
    &file,
    "/fat12/hello/file/write/append.txt",
    O_RDWR | O_APPEND
  );
  EXPECT_EQ( result, EOK );
  EXPECT_NE( file.cluster, 0 );
...
TEST( fat12, file_ftruncate_ro ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // open file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/trunc/extend.txt", O_RDONLY );
  EXPECT_EQ( result, EOK );
  // save old size
  ...
  EXPECT_EQ( result, EOK );
  // open file again
  result = fat_file_open2( &file, "/fat12/hello/trunc/extend.txt", O_RDONLY );
  EXPECT_EQ( result, EOK );
  EXPECT_EQ( file.fsize, old_size );
  // close file again
  result = fat_file_close( &file );
...
TEST( fat12, file_ftruncate_extend_cluster ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // open file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/trunc/extend.txt", O_RDWR );
  EXPECT_EQ( result, EOK );
  // save old size
...
TEST( fat12, file_ftruncate_extend_cluster_times_n ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
...
TEST( fat12, file_ftruncate_shrink_cluster ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // open file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/trunc/shrink.txt", O_RDWR );
  EXPECT_EQ( result, EOK );
  // save old size
  fat_fs_t* fs = ( fat_fs_t* )file.mp->fs;
  uint64_t cluster_size = fs->superblock.bytes_per_sector
  ...
  EXPECT_EQ( result, EOK );
  // open file again
  result = fat_file_open2( &file, "/fat12/hello/trunc/shrink.txt", O_RDWR );
  EXPECT_EQ( result, EOK );
  EXPECT_EQ( file.fsize, truncate_size );
  // call for truncate
...
TEST( fat12, file_ftruncate_extend_size_only ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // open file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/trunc/extend2.txt", O_RDWR );
  EXPECT_EQ( result, EOK );
  // save old size
  uint64_t old_size = file.fsize;
  // call for truncate
  ...
  EXPECT_EQ( result, EOK );
  // open file again
  result = fat_file_open2( &file, "/fat12/hello/trunc/extend2.txt", O_RDONLY );
  EXPECT_EQ( result, EOK );
  EXPECT_EQ( file.fsize, old_size * 2 );
  // close file again
  result = fat_file_close( &file );
...
TEST( fat12, file_ftruncate_shrink_size_only ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // open file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  int result = fat_file_open2( &file, "/fat12/hello/trunc/shrink2.txt", O_RDWR );
  EXPECT_EQ( result, EOK );
  // save old size
  uint64_t old_size = file.fsize;
  // call for truncate
  ...
  EXPECT_EQ( result, EOK );
  // open file again
  result = fat_file_open2( &file, "/fat12/hello/trunc/shrink2.txt", O_RDONLY );
  EXPECT_EQ( result, EOK );
  EXPECT_EQ( file.fsize, old_size / 2 );
  // close file again
  result = fat_file_close( &file );
...
TEST( fat12, file_ftruncate_free_cluster_size ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // open file
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
TEST( fat12, file_move_rootdir_ro_fail ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to remove directory
  int result = fat_file_move( "/fat12/fmove.txt", "/fat12/fmove2.txt" );
  EXPECT_EQ( result, EROFS );
  // directory variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  ...
  EXPECT_EQ( file.fsize, strlen("hello world\n") );
  // open base directory
  result = fat_file_open2( &file, "/fat12/fmove2.txt", O_RDONLY );
  EXPECT_EQ( result, ENOENT );
  // close directory again
  result = fat_file_close( &file );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_move_rootdir_rw_short_name_success ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to remove directory
  int result = fat_file_move( "/fat12/fmove.txt", "/fat12/fmove2.txt" );
  EXPECT_EQ( result, EOK );
  ...
  result = fat_file_move( "/fat12/fmove2.txt", "/fat12/fmove.txt" );
  EXPECT_EQ( result, EOK );
  // open base directory
  result = fat_directory_open( &dir, "/fat12/" );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_move_rootdir_rw_long_name_success ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to remove directory
  int result = fat_file_move( "/fat12/fmovelongname.txt", "/fat12/fmovelongname2.txt" );
  EXPECT_EQ( result, EOK );
  // directory variable
  fat_directory_t dir;
  memset( &dir, 0, sizeof( dir ) );
  ...
  EXPECT_EQ( result, EOK );
  // try to revert directory move
  result = fat_file_move( "/fat12/fmovelongname2.txt", "/fat12/fmovelongname.txt" );
  EXPECT_EQ( result, EOK );
  // open base directory
  result = fat_directory_open( &dir, "/fat12/" );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_move_dir_ro_fail ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to remove directory
  int result = fat_file_move( "/fat12/hello/file/fmove.txt", "/fat12/hello/file/fmove2.txt" );
  EXPECT_EQ( result, EROFS );
  // directory variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
  ...
  EXPECT_EQ( result, EOK );
  // open base directory
  result = fat_file_open2( &file, "/fat12/hello/file/fmove2.txt", O_RDONLY );
  EXPECT_EQ( result, ENOENT );
  // unmount test image
  helper_unmount_test_image( "fat12", "/fat12/" );
}
...
TEST( fat12, file_move_dir_rw_short_name_success ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to remove directory
  int result = fat_file_move( "/fat12/hello/file/fmove.txt", "/fat12/hello/file/fmove2.txt" );
  EXPECT_EQ( result, EOK );
  ...
  memset( &dir, 0, sizeof( dir ) );
  // open base directory
  result = fat_directory_open( &dir, "/fat12/hello/file/" );
  EXPECT_EQ( result, EOK );
  // get by name
  result = fat_directory_entry_by_name( &dir, "fmove.txt" );
  EXPECT_EQ( result, ENOENT );
  ...
  EXPECT_EQ( result, EOK );
  // try to revert directory move
  result = fat_file_move( "/fat12/hello/file/fmove2.txt", "/fat12/hello/file/fmove.txt" );
  EXPECT_EQ( result, EOK );
  // open base directory
  result = fat_directory_open( &dir, "/fat12/hello/file/" );
  EXPECT_EQ( result, EOK );
...
TEST( fat12, file_move_dir_rw_long_name_success ) {
  helper_mount_test_image( false, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // try to remove directory
  int result = fat_file_move( "/fat12/hello/file/fmovelongname.txt", "/fat12/hello/file/fmovelongname2.txt" );
  EXPECT_EQ( result, EOK );
  // directory variable
  fat_directory_t dir;
  memset( &dir, 0, sizeof( dir ) );
  ...
  EXPECT_EQ( result, EOK );
  // try to revert directory move
  result = fat_file_move( "/fat12/hello/file/fmovelongname2.txt", "/fat12/hello/file/fmovelongname.txt" );
  EXPECT_EQ( result, EOK );
  // open base directory
  result = fat_directory_open( &dir, "/fat12/" );
  EXPECT_EQ( result, EOK );
