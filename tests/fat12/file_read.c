...
START_TEST( test_file_read_normal1 ) {
...
START_TEST( test_file_read_normal2 ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
START_TEST( test_file_read_rootdir ) {
  helper_mount_test_image( true, "fat12.img", "fat12", "/fat12/", FAT_FAT12 );
  // file variable
  fat_file_t file;
  memset( &file, 0, sizeof( file ) );
...
Suite* fat12_suite_file_read(void) {
  ...
  tcase_add_test( tc_core, test_file_read_normal2 );
  tcase_add_test( tc_core, test_file_read_rootdir );
